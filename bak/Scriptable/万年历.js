...
class Widget extends BaseWidget {
  ...
  defaultPreference = {
    weekdayTitleDayColor: '#000000',
    weekdayTitleNightColor: '#FFFFF0',

    weekendTitleDayColor: '#000000',
    weekendTitleNightColor: '#FFFFF0',

    notCurrMonthDayColor: '#66cccc',
    notCurrMonthNightColor: '#66cccc',

    weekdayDateDayColor: '#000000',
    weekdayDateNightColor: '#FFFFF0',

    holidayDateDayColor: '#F73131',
    holidayDateNightColor: '#F73131',

    todayDayColor: '#FF9999',
    todayNightColor: '#FF9999',

    monthBgTextDayColor: '#F0F3FC',
    monthBgTextNightColor: '#245567',
  };
              ...
              items: [
                {
                  ...
                  label: '工作日标题浅色颜色',
                  type: 'color',
                  icon: { name: 'pencil.and.outline', color: '#000000' },
                  needLoading: false,
                ...
                },
                {
                  ...
                  label: '工作日标题深色颜色',
                  type: 'color',
                  icon: { name: 'square.and.pencil', color: '#FFFFF0' },
                  needLoading: false,
              ...
              items: [
                {
                  ...
                  label: '非当前月浅色颜色',
                  type: 'color',
                  icon: { name: 'pencil.and.outline', color: '#66cccc' },
                  needLoading: false,
                ...
                },
                {
                  ...
                  label: '非当前月深色颜色',
                  type: 'color',
                  icon: { name: 'square.and.pencil', color: '#66cccc' },
                  needLoading: false,
              ...
              items: [
                {
                  ...
                  label: '节假日日期浅色颜色',
                  type: 'color',
                  icon: { name: 'pencil.and.outline', color: '#F73131' },
                  needLoading: false,
                ...
                },
                {
                  ...
                  label: '节假日日期深色颜色',
                  type: 'color',
                  icon: { name: 'square.and.pencil', color: '#F73131' },
                  needLoading: false,
              ...
              items: [
                {
                  ...
                  label: '今日日期浅色颜色',
                  type: 'color',
                  icon: { name: 'pencil.and.outline', color: '#FFCCCC' },
                  needLoading: false,
                ...
                },
                {
                  ...
                  label: '今日日期深色颜色',
                  type: 'color',
                  icon: { name: 'square.and.pencil', color: '#FFCCCC' },
                  needLoading: false,
              ...
              items: [
                {
                  ...
                  label: '当前月份浅色颜色',
                  type: 'color',
                  icon: { name: 'pencil.and.outline', color: '#F0F3FC' },
                  needLoading: false,
                ...
                },
                {
                  ...
                  label: '当前月份深色颜色',
                  type: 'color',
                  icon: { name: 'square.and.pencil', color: '#245567' },
                  needLoading: false,
